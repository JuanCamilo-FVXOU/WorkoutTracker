package com.workout_tracker.infrastructure.driven_adapter.postgres.helper;
...
public abstract class ReactiveAdapterOperations<E, D, I, R extends ReactiveCrudRepository<D, I> & ReactiveQueryByExampleExecutor<D>> {
    ...
    protected ReactiveAdapterOperations(R repository, ModelMapper mapper, Function<D, E> toEntityFn) {
